...
class TestNewImportPath:
    ...
    def test_default_allowlist_importable(self) -> None:
        ...
        from agent_fox.core.security import DEFAULT_ALLOWLIST  # noqa: PLC0415
    ...
    def test_build_effective_allowlist_importable(self) -> None:
        ...
        from agent_fox.core.security import build_effective_allowlist  # noqa: PLC0415
    ...
    def test_check_command_allowed_importable(self) -> None:
        ...
        from agent_fox.core.security import check_command_allowed  # noqa: PLC0415
    ...
    def test_extract_command_name_importable(self) -> None:
        ...
        from agent_fox.core.security import extract_command_name  # noqa: PLC0415
    ...
    def test_check_shell_operators_importable(self) -> None:
        ...
        from agent_fox.core.security import check_shell_operators  # noqa: PLC0415
...
class TestOldImportFails:
    ...
    def test_old_security_security_import_fails(self) -> None:
        """Importing from agent_fox.security.security must raise ImportError."""
        with pytest.raises(ImportError):
            from agent_fox.security.security import make_pre_tool_use_hook  # noqa: F401, PLC0415
