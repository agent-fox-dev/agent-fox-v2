...
def _migrate_v9(conn: duckdb.DuckDBPyConnection) -> None:
    ...
    if col_info is not None:
        logger.info("memory_facts.keywords already exists, skipping v9 migration")
        return
...
MIGRATIONS: list[Migration] = [
    ...
    # v9 is reserved for Spec 102 (multilang entity graph) which adds a
    # language column to entity_graph.  See test_multilang_analysis.py.
    Migration(
        version=10,
