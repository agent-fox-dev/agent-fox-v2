...
_LEGACY_FOOTERS: tuple[str, ...] = ("## For all configuration options, see docs/config-reference.md",)
...
def _ensure_footer(lines: list[str], footer: str) -> None:
    ...
    Requirements: 68-REQ-6.1, 68-REQ-6.E1
    """
    # Remove all existing occurrences of the current footer and any legacy footers
    all_footers = {footer.strip()} | {lf.strip() for lf in _LEGACY_FOOTERS}
